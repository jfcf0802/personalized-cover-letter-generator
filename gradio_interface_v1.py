...
import gradio as gr
import torch
from transformers import AutoModelForCausalLM, LlamaTokenizer, pipeline, AutoTokenizer
...
def generate_cover_letter(company_name, position_name, job_description, resume_content):
    ...
    generated_response = generator(prompt, max_new_tokens=512, temperature=0.7)
